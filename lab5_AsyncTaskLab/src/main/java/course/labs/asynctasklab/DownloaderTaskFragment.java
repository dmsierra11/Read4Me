...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Bundle args_ = this.getArguments();
        ArrayList<Integer> resourceIDS = args_.getIntegerArrayList("friends");
	...
	public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Integer, String[]> {
        ...
        protected String[] doInBackground(ArrayList<Integer>... params) {
            ArrayList<Integer> resIDS = params[0];
            Integer[] resIDSArr = new Integer[resIDS.size()];
            for (int i=0; i < resIDSArr.length; i++){
                resIDSArr[i] = resIDS.get(i);
            }
            return downloadTweets(resIDSArr);
        }

        @Override
        protected void onPostExecute(String[] feeds) {
            Log.d(TAG, "Finished "+feeds.toString());
